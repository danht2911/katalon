...
def checksort(ArrayList<LocalDateTime> dateTimeArray) {
...
// convert string => datetime & sort


//		for (LocalDateTime x : datetime) {
//			for (LocalDateTime y : increasedatetime) {
//				if (x == y) {
//					println(x + " " + y) }
//				else {
//					break; }
...
//	ArrayList<LocalDateTime> reversedatetime = new ArrayList (datetime);
//
//	println(reversedatetime + " day so cu da duoc sap xep giam dan");
